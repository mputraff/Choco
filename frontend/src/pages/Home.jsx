    ...
    <>
        ...
        <div className="w-full h-full flex items-center gap-24 justify-center max-sm:flex-col max-sm:gap-0">
          <div className=" h-3/5 flex max-sm:hidden max-md:hidden">
            <img
              src={imgHome}
              alt="imgHome"
              className="max-sm:w-64 max-sm:mt-8"
            />
          </div>
          <div className="w-1/2 text-justify flex flex-col gap-9 max-sm:w-3/4 max-md:w-3/4 ">
            <h2 className="text-white text-5xl font-semibold max-sm:text-3xl max-md:text-4xl  ">
              Bersama Cegah Stunting untuk Masa Depan yang Lebih Sehat
            </h2>
            <p className="text-white text-2xl max-sm:text-xl">
              <b>Apa itu stunting?</b>
            </p>
            <p className="text-white text-xl max-sm:text-lg">
              Stunting adalah masalah serius yang mengancam perkembangan
              anak-anak kita. Mari bergandengan tangan untuk memastikan setiap
              anak mendapatkan nutrisi dan perawatan yang mereka butuhkan agar
              tumbuh sehat dan kuat. Dengan informasi, dukungan, dan tindakan
              nyata, kita bisa mengubah masa depan generasi mendatang.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="About" className="w-full h-svh max-sm:h-auto max-md:h-auto">
        <div className="w-full h-full flex items-center gap-14 justify-center max-sm:flex-col-reverse max-md:flex-col-reverse max-sm:my-8 max-md:my-8 ">
          <div className="w-5/12 text-justify flex flex-col gap-10 ml-10 text-black max-sm:w-9/12 max-sm:ml-0 max-md:w-9/12 max-md:ml-0 ">
            ...
            <p className="text-lg ">
              Grafik ini menunjukkan tren peningkatan angka stunting di
              Indonesia selama tahun 2023. Terlihat adanya kenaikan persentase
              anak-anak di bawah usia lima tahun yang mengalami stunting, yang
              mengindikasikan permasalahan gizi dan kesehatan yang perlu segera
              ditangani
            </p>
            <p className="text-lg">
              Untuk mencegah stunting, kita perlu mengambil langkah-langkah
              berikut: Peningkatan gizi ibu hamil untuk memastikan nutrisi yang
              cukup dan seimbang selama kehamilan, pemberian Air Susu Ibu (ASI)
              eksklusif selama enam bulan pertama kehidupan bayi karena ASI
              mengandung semua nutrisi yang dibutuhkan untuk pertumbuhan
              optimal, dan pemberian makanan pendamping ASI yang kaya akan zat
              gizi setelah enam bulan untuk memenuhi kebutuhan nutrisi anak.
            </p>
          </div>
      ...
      <section className="w-full h-svh max-md:h-auto">
        <div className="flex flex-col items-center gap-4 justify-center h-full bg-slate-600">
          <h3 className="text-3xl font-semibold w-2/4 text-center text-white max-md:text-xl max-md:mt-8">
            Tabel Standar Pertumbuhan Anak Berdasarkan Usia (0-2 Tahun)
          </h3>
          <DataBayi />
        </div>
      </section>
